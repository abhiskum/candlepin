...
public class HealEntireOrgJobTest extends BaseJobTest {
    ...
    public void testHealEntireOrgJob() throws JobExecutionException {
        ...
        expectedResult.append("Healing event sent for consumer: ").append(consumer1.getUuid()).append("\n");
        expectedResult.append("Healing event sent for consumer: ").append(consumer2.getUuid()).append("\n");
